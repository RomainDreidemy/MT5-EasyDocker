...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.DockerHubSearchImagesResponse"
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.DockerHubTagResponse"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "models.DockerHubImage": {
            ...
            "properties": {
                "architectures": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.DockerHubArchitecture"
                    }
                },
                "categories": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.DockerHubCategory"
                    }
                },
                ...
                "logo_url": {
                    "$ref": "#/definitions/models.DockerHubLogoURL"
                },
                "name": {
                    "type": "string"
                },
                "operating_systems": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.DockerHubOperatingSystem"
                    }
                },
                "popularity": {
                    "type": "integer"
                ...
                "publisher": {
                    "$ref": "#/definitions/models.DockerHubPublisher"
                },
                "short_description": {
                    "type": "string"
                },
        ...
        "models.DockerHubOperatingSystem": {
            "type": "object",
            "properties": {
                "label": {
                    "type": "string"
        ...
        "models.DockerHubSearchImagesResponse": {
            "type": "object",
            "properties": {
                "count": {
                    "type": "integer"
                ...
                "summaries": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.DockerHubImage"
                    }
                }
            }
        },
        "models.DockerHubTag": {
            ...
            "properties": {
                ...
                "images": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.DockerHubTagImage"
                    }
                },
                "last_updated": {
                    "type": "string"
        ...
        "models.DockerHubTagResponse": {
            ...
            "properties": {
                ...
                "results": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.DockerHubTag"
                    }
                }
            }
        },
